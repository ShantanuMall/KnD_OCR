...
@torch.no_grad()
def run(weights=r"/Users/punit/Downloads/OneDrive_1_24-05-2024/OCR_Model/weights/best_OCR.pt",  # model.pt path(s)
...
#     print(main(source=r"D:\Forbmax User Data\waqar sahi\SmartMeter\yolo\Test_OCR\image_10.jpg"))
